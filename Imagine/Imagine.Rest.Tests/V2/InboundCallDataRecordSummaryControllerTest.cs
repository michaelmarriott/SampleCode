...
namespace Imagine.Rest.Tests.V2 {
  [TestClass]
  public class InboundCallDataRecordSummaryControllerTest {

    InboundCallDataRecordSummaryController controller;
    [TestInitialize]
    public void SetUp() {
      controller = new InboundCallDataRecordSummaryController();
      controller.Request = new HttpRequestMessage();
      controller.Request.SetConfiguration(new HttpConfiguration());
    }

    [TestMethod]
    public void GetInboundCallDataRecordSummary() {
      int lobId = 1;
      ...
      using (ShimsContext.Create()) {
        CallDataRecord.PopulateInboundCallDataRecordSummaryDataSet();
