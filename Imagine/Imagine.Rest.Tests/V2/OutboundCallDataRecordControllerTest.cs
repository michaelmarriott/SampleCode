...
namespace Imagine.Rest.Tests.V2 {
  [TestClass]
  public class OutboundCallDataRecordControllerTest {

    OutboundCallDataRecordController controller;
    [TestInitialize]
    public void SetUp() {
      controller = new OutboundCallDataRecordController();
      controller.Request = new HttpRequestMessage();
      controller.Request.SetConfiguration(new HttpConfiguration());
    }

    [TestMethod]
    public void GetOutboundCallDataRecord() {
      int lobId = 1;
